                                                ...
                                                <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="kodeMapel" class="col-sm-3 col-form-label">Kode Mata Pelajaran</label>
                                                                    <div class="col-sm-9">
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                                <input required type="text" name="nama_mapel" class="form-control" id="namaMapel" placeholder="Masukkan Nama Mata Pelajaran" value="<?php echo $nama_mapel; ?>">
                                                                        </div>
                                                                </div>                
                                                        </div>
